...
export default function MyFees() {
  ...
  return (
    <div>
      <PageHeader title="My Fees" subtitle={`Pay via UPI: ${org.upiId || '—'}`} />
      ...
      <Card>
        <div className="px-4 py-3 border-b border-slate-100 font-semibold text-slate-800">Payment history &amp; receipts</div>
